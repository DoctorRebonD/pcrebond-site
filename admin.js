...
async function editPhoto(id,title,caption){const t=prompt('Titre',title);if(t===null)return;const c=prompt('Légende',caption);if(c===null)return;await api(`/api/admin/gallery/${id}`,{method:'PUT',headers:{'content-type':'application/json'},body:JSON.stringify({title:t,caption:c})});gallery();}
reviews();gallery();
